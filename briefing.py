...
from tools import read_email, read_imessage, search_web, send_imessage, polymarket_search, polymarket_movers, polymarket_dashboard, trends_search, trends_related, trends_trending, get_weather
...
_modules = [read_email, read_imessage, search_web, send_imessage, polymarket_search, polymarket_movers, polymarket_dashboard, trends_search, trends_related, trends_trending, get_weather]
